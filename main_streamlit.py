...
if userchoice==1 : #SOAL A
    ...
    st.subheader("Grafik")
    kumpulandata22.plot(kind="bar", x="kode_negara", y="produksi", title="Grafik Produksi Minyak Terbesar Pada Tahun Input User", xlabel="negara", ylabel='produksi')
    b = plt.show()
    plota = st.pyplot(b)
    ...
    st.subheader("Grafik")
    kumpulandata33.plot(kind="bar", x="kode_negara", y="produksi_kumulatif", title="Grafik Produksi Minyak Kumulatif Terbesar", xlabel="negara", ylabel='produksi kumulatif')
    c = plt.show()
    plota = st.pyplot(c)
