...
df = pd.read_csv("https://drive.google.com/file/d/1Z9usxdB15Tx5sDt5tKm356SbbjKYRGOu/view?usp=sharing")
with open("https://drive.google.com/file/d/1eRZLc_K7tlHEuOGvKJ_KHVwj6Js_otge/view?usp=sharing") as f:
    datauas = json.load(f)
...
if userchoice==1 : #SOAL A
    #input nama negara
    inputnegara1 = st.selectbox("Masukkan nama negara", listnegarafix)
    ...
    inputtahun2 = col2.selectbox('Masukkan tahun: ', listtahunfix)
    ...
    #input T
    inputtahun4 = st.selectbox('Masukkan tahun: ', listtahunfix)
    ...
    col1.markdown(f"**Jumlah produksi** : ", kumpulandatad1t.loc[imax2, "produksi"])
